...
static bool test_movzx_rr(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);
    ...
    Elf_Test_Proc* proc0 = push_test_proc(mem_arena, &elf_prog);
    X64_emit_instr_mov_ri(&proc0->x64_instrs, 1, X64_RCX, 2);
    X64_emit_instr_mov_ri(&proc0->x64_instrs, 1, X64_R10, -1);

    X64_emit_instr_movzx_rr(&proc0->x64_instrs, 2, X64_RAX, 1, X64_RSI); // rsi aliases with dh
    X64_emit_instr_movzx_rr(&proc0->x64_instrs, 4, X64_RAX, 1, X64_RCX);
    X64_emit_instr_movzx_rr(&proc0->x64_instrs, 8, X64_RAX, 1, X64_RCX);
    X64_emit_instr_movzx_rr(&proc0->x64_instrs, 4, X64_RAX, 2, X64_RCX);
    X64_emit_instr_movzx_rr(&proc0->x64_instrs, 8, X64_RAX, 2, X64_RCX);

    X64_emit_instr_movzx_rr(&proc0->x64_instrs, 2, X64_R11, 1, X64_R10);
    X64_emit_instr_movzx_rr(&proc0->x64_instrs, 4, X64_R11, 1, X64_R10);
    X64_emit_instr_movzx_rr(&proc0->x64_instrs, 8, X64_R11, 1, X64_R10);
    X64_emit_instr_movzx_rr(&proc0->x64_instrs, 4, X64_R11, 2, X64_R10);
    X64_emit_instr_movzx_rr(&proc0->x64_instrs, 8, X64_R11, 2, X64_R10);
...
static bool test_movzx_rm(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);
    ...
    X64_emit_instr_movzx_rm(&proc0->x64_instrs, 2, X64_RAX, 1, rsp_addr);
    X64_emit_instr_movzx_rm(&proc0->x64_instrs, 4, X64_RAX, 1, rsp_addr);
    X64_emit_instr_movzx_rm(&proc0->x64_instrs, 8, X64_RAX, 1, rsp_addr);
    X64_emit_instr_movzx_rm(&proc0->x64_instrs, 4, X64_RAX, 2, rsp_addr);
    X64_emit_instr_movzx_rm(&proc0->x64_instrs, 8, X64_RAX, 2, rsp_addr);

    X64_emit_instr_movzx_rm(&proc0->x64_instrs, 2, X64_R11, 1, r10_addr);
    X64_emit_instr_movzx_rm(&proc0->x64_instrs, 4, X64_R11, 1, r10_addr);
    X64_emit_instr_movzx_rm(&proc0->x64_instrs, 8, X64_R11, 1, r10_addr);
    X64_emit_instr_movzx_rm(&proc0->x64_instrs, 4, X64_R11, 2, r10_addr);
    X64_emit_instr_movzx_rm(&proc0->x64_instrs, 8, X64_R11, 2, r10_addr);
    ...
    const char* nasm_code = "proc0:\n"
                            " mov dword [rsp - 0x8], -2\n"
                            " mov r10, rsp\n"
                            " movzx ax, byte [rsp - 0x8]\n"
                            " movzx eax, byte [rsp - 0x8]\n"
                            " movzx rax, byte [rsp - 0x8]\n"
                            " movzx eax, word [rsp - 0x8]\n"
                            " movzx rax, word [rsp - 0x8]\n"
                            " movzx r11w, byte [r10 - 0x8]\n"
                            " movzx r11d, byte [r10 - 0x8]\n"
                            " movzx r11, byte [r10 - 0x8]\n"
                            " movzx r11d, word [r10 - 0x8]\n"
                            " movzx r11, word [r10 - 0x8]\n"
                            " ret\n";
    if (!get_nasm_machine_code(&nasm_buffer, nasm_code, mem_arena)) {
        return false;
    }
...
static bool test_movdqu_rm(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);

    Elf_Test_Proc* proc0 = push_test_proc(mem_arena, &elf_prog);
    X64_SIBD_Addr rbp_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_RBP, .local.disp = -16};
    X64_SIBD_Addr rsp_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_RSP, .local.disp = -16};
    X64_SIBD_Addr r10_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_R10, .local.disp = -16};
    X64_emit_instr_movdqu_rm(&proc0->x64_instrs, X64_XMM1, rbp_addr);
    X64_emit_instr_movdqu_rm(&proc0->x64_instrs, X64_XMM11, rsp_addr);
    X64_emit_instr_movdqu_rm(&proc0->x64_instrs, X64_XMM2, r10_addr);
    X64_emit_instr_movdqu_rm(&proc0->x64_instrs, X64_XMM8, rbp_addr);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);

    Array(u8) nasm_buffer = array_create(mem_arena, u8, 64);
    const char* nasm_code = "proc0:\n"
                            " movdqu xmm1, oword [rbp - 16]\n"
                            " movdqu xmm11, oword [rsp - 16]\n"
                            " movdqu xmm2, oword [r10 - 16]\n"
                            " movdqu xmm8, oword [rbp - 16]\n"
                            " ret\n";
    if (!get_nasm_machine_code(&nasm_buffer, nasm_code, mem_arena)) {
        return false;
    }
...
static bool test_movdqu_mr(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);
    ...
    X64_SIBD_Addr rsp_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_RSP, .local.disp = -16};
    X64_SIBD_Addr r10_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_R10, .local.disp = -16};
    X64_emit_instr_movdqu_mr(&proc0->x64_instrs, rbp_addr, X64_XMM1);
    X64_emit_instr_movdqu_mr(&proc0->x64_instrs, rsp_addr, X64_XMM11);
    X64_emit_instr_movdqu_mr(&proc0->x64_instrs, r10_addr, X64_XMM2);
    X64_emit_instr_movdqu_mr(&proc0->x64_instrs, rbp_addr, X64_XMM8);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);

    Array(u8) nasm_buffer = array_create(mem_arena, u8, 64);
    const char* nasm_code = "proc0:\n"
                            " movdqu oword [rbp - 16], xmm1\n"
                            " movdqu oword [rsp - 16], xmm11\n"
                            " movdqu oword [r10 - 16], xmm2\n"
                            " movdqu oword [rbp - 16], xmm8\n"
                            " ret\n";
    if (!get_nasm_machine_code(&nasm_buffer, nasm_code, mem_arena)) {
        return false;
    }
...
static bool test_add_flt_rr(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);

    Elf_Test_Proc* proc0 = push_test_proc(mem_arena, &elf_prog);
    X64_emit_instr_add_flt_rr(&proc0->x64_instrs, FLOAT_F32, X64_XMM1, X64_XMM8);
    X64_emit_instr_add_flt_rr(&proc0->x64_instrs, FLOAT_F32, X64_XMM11, X64_XMM1);
    X64_emit_instr_add_flt_rr(&proc0->x64_instrs, FLOAT_F64, X64_XMM1, X64_XMM9);
    X64_emit_instr_add_flt_rr(&proc0->x64_instrs, FLOAT_F64, X64_XMM11, X64_XMM1);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);
...
static bool test_add_flt_rm(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);
    ...
    X64_SIBD_Addr rsp_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_RSP, .local.disp = -8};
    X64_SIBD_Addr r10_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_R10, .local.disp = -8};
    X64_emit_instr_add_flt_rm(&proc0->x64_instrs, FLOAT_F32, X64_XMM1, rbp_addr);
    X64_emit_instr_add_flt_rm(&proc0->x64_instrs, FLOAT_F32, X64_XMM11, rsp_addr);
    X64_emit_instr_add_flt_rm(&proc0->x64_instrs, FLOAT_F64, X64_XMM1, r10_addr);
    X64_emit_instr_add_flt_rm(&proc0->x64_instrs, FLOAT_F64, X64_XMM8, rbp_addr);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);

    Array(u8) nasm_buffer = array_create(mem_arena, u8, 64);
    const char* nasm_code = "proc0:\n"
                            " addss xmm1, dword [rbp - 8]\n"
                            " addss xmm11, dword [rsp - 8]\n"
                            " addsd xmm1, qword [r10 - 8]\n"
                            " addsd xmm8, qword [rbp - 8]\n"
                            " ret\n";
    if (!get_nasm_machine_code(&nasm_buffer, nasm_code, mem_arena)) {
        return false;
    }
...
// SUB FLT
static bool test_sub_flt_rr(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);

    Elf_Test_Proc* proc0 = push_test_proc(mem_arena, &elf_prog);
    X64_emit_instr_sub_flt_rr(&proc0->x64_instrs, FLOAT_F32, X64_XMM1, X64_XMM2);
    X64_emit_instr_sub_flt_rr(&proc0->x64_instrs, FLOAT_F32, X64_XMM1, X64_XMM8);
    X64_emit_instr_sub_flt_rr(&proc0->x64_instrs, FLOAT_F32, X64_XMM11, X64_XMM1);
    X64_emit_instr_sub_flt_rr(&proc0->x64_instrs, FLOAT_F64, X64_XMM1, X64_XMM2);
    X64_emit_instr_sub_flt_rr(&proc0->x64_instrs, FLOAT_F64, X64_XMM1, X64_XMM9);
    X64_emit_instr_sub_flt_rr(&proc0->x64_instrs, FLOAT_F64, X64_XMM11, X64_XMM1);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);
...
static bool test_sub_flt_rm(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);
    ...
    X64_SIBD_Addr rsp_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_RSP, .local.disp = -8};
    X64_SIBD_Addr r10_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_R10, .local.disp = -8};
    X64_emit_instr_sub_flt_rm(&proc0->x64_instrs, FLOAT_F32, X64_XMM1, rbp_addr);
    X64_emit_instr_sub_flt_rm(&proc0->x64_instrs, FLOAT_F32, X64_XMM11, rsp_addr);
    X64_emit_instr_sub_flt_rm(&proc0->x64_instrs, FLOAT_F64, X64_XMM1, r10_addr);
    X64_emit_instr_sub_flt_rm(&proc0->x64_instrs, FLOAT_F64, X64_XMM8, rbp_addr);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);

    Array(u8) nasm_buffer = array_create(mem_arena, u8, 64);
    const char* nasm_code = "proc0:\n"
                            " subss xmm1, dword [rbp - 8]\n"
                            " subss xmm11, dword [rsp - 8]\n"
                            " subsd xmm1, qword [r10 - 8]\n"
                            " subsd xmm8, qword [rbp - 8]\n"
                            " ret\n";
    if (!get_nasm_machine_code(&nasm_buffer, nasm_code, mem_arena)) {
        return false;
    }
...
// MUL FLT
static bool test_mul_flt_rr(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);

    Elf_Test_Proc* proc0 = push_test_proc(mem_arena, &elf_prog);
    X64_emit_instr_mul_flt_rr(&proc0->x64_instrs, FLOAT_F32, X64_XMM1, X64_XMM2);
    X64_emit_instr_mul_flt_rr(&proc0->x64_instrs, FLOAT_F32, X64_XMM1, X64_XMM8);
    X64_emit_instr_mul_flt_rr(&proc0->x64_instrs, FLOAT_F32, X64_XMM11, X64_XMM1);
    X64_emit_instr_mul_flt_rr(&proc0->x64_instrs, FLOAT_F64, X64_XMM1, X64_XMM2);
    X64_emit_instr_mul_flt_rr(&proc0->x64_instrs, FLOAT_F64, X64_XMM1, X64_XMM9);
    X64_emit_instr_mul_flt_rr(&proc0->x64_instrs, FLOAT_F64, X64_XMM11, X64_XMM1);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);
...
static bool test_mul_flt_rm(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);
    ...
    X64_SIBD_Addr rsp_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_RSP, .local.disp = -8};
    X64_SIBD_Addr r10_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_R10, .local.disp = -8};
    X64_emit_instr_mul_flt_rm(&proc0->x64_instrs, FLOAT_F32, X64_XMM1, rbp_addr);
    X64_emit_instr_mul_flt_rm(&proc0->x64_instrs, FLOAT_F32, X64_XMM11, rsp_addr);
    X64_emit_instr_mul_flt_rm(&proc0->x64_instrs, FLOAT_F64, X64_XMM1, r10_addr);
    X64_emit_instr_mul_flt_rm(&proc0->x64_instrs, FLOAT_F64, X64_XMM8, rbp_addr);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);

    Array(u8) nasm_buffer = array_create(mem_arena, u8, 64);
    const char* nasm_code = "proc0:\n"
                            " mulss xmm1, dword [rbp - 8]\n"
                            " mulss xmm11, dword [rsp - 8]\n"
                            " mulsd xmm1, qword [r10 - 8]\n"
                            " mulsd xmm8, qword [rbp - 8]\n"
                            " ret\n";
    if (!get_nasm_machine_code(&nasm_buffer, nasm_code, mem_arena)) {
        return false;
    }
...
// DIV FLT
static bool test_div_flt_rr(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);

    Elf_Test_Proc* proc0 = push_test_proc(mem_arena, &elf_prog);
    X64_emit_instr_div_flt_rr(&proc0->x64_instrs, FLOAT_F32, X64_XMM1, X64_XMM2);
    X64_emit_instr_div_flt_rr(&proc0->x64_instrs, FLOAT_F32, X64_XMM1, X64_XMM8);
    X64_emit_instr_div_flt_rr(&proc0->x64_instrs, FLOAT_F32, X64_XMM11, X64_XMM1);
    X64_emit_instr_div_flt_rr(&proc0->x64_instrs, FLOAT_F64, X64_XMM1, X64_XMM2);
    X64_emit_instr_div_flt_rr(&proc0->x64_instrs, FLOAT_F64, X64_XMM1, X64_XMM9);
    X64_emit_instr_div_flt_rr(&proc0->x64_instrs, FLOAT_F64, X64_XMM11, X64_XMM1);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);
...
static bool test_div_flt_rm(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);
    ...
    X64_SIBD_Addr rsp_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_RSP, .local.disp = -8};
    X64_SIBD_Addr r10_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_R10, .local.disp = -8};
    X64_emit_instr_div_flt_rm(&proc0->x64_instrs, FLOAT_F32, X64_XMM1, rbp_addr);
    X64_emit_instr_div_flt_rm(&proc0->x64_instrs, FLOAT_F32, X64_XMM11, rsp_addr);
    X64_emit_instr_div_flt_rm(&proc0->x64_instrs, FLOAT_F64, X64_XMM1, r10_addr);
    X64_emit_instr_div_flt_rm(&proc0->x64_instrs, FLOAT_F64, X64_XMM8, rbp_addr);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);

    Array(u8) nasm_buffer = array_create(mem_arena, u8, 64);
    const char* nasm_code = "proc0:\n"
                            " divss xmm1, dword [rbp - 8]\n"
                            " divss xmm11, dword [rsp - 8]\n"
                            " divsd xmm1, qword [r10 - 8]\n"
                            " divsd xmm8, qword [rbp - 8]\n"
                            " ret\n";
    if (!get_nasm_machine_code(&nasm_buffer, nasm_code, mem_arena)) {
        return false;
    }
...
// FLT UCMP
static bool test_ucomp_flt_rr(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);

    Elf_Test_Proc* proc0 = push_test_proc(mem_arena, &elf_prog);
    X64_emit_instr_ucomiss_rr(&proc0->x64_instrs, X64_XMM1, X64_XMM2);
    X64_emit_instr_ucomiss_rr(&proc0->x64_instrs, X64_XMM1, X64_XMM8);
    X64_emit_instr_ucomiss_rr(&proc0->x64_instrs, X64_XMM11, X64_XMM1);
    X64_emit_instr_ucomisd_rr(&proc0->x64_instrs, X64_XMM1, X64_XMM2);
    X64_emit_instr_ucomisd_rr(&proc0->x64_instrs, X64_XMM1, X64_XMM9);
    X64_emit_instr_ucomisd_rr(&proc0->x64_instrs, X64_XMM11, X64_XMM1);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);
...
static bool test_ucomp_flt_rm(Allocator* mem_arena, bool verbose)
{
    Elf_Test_Prog elf_prog = {0};
    init_test_program(mem_arena, &elf_prog);
    ...
    X64_SIBD_Addr rsp_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_RSP, .local.disp = -8};
    X64_SIBD_Addr r10_addr = {.kind = X64_SIBD_ADDR_LOCAL, .local.base_reg = X64_R10, .local.disp = -8};
    X64_emit_instr_ucomiss_rm(&proc0->x64_instrs, X64_XMM1, rbp_addr);
    X64_emit_instr_ucomiss_rm(&proc0->x64_instrs, X64_XMM1, rsp_addr);
    X64_emit_instr_ucomiss_rm(&proc0->x64_instrs, X64_XMM11, r10_addr);
    X64_emit_instr_ucomisd_rm(&proc0->x64_instrs, X64_XMM1, rbp_addr);
    X64_emit_instr_ucomisd_rm(&proc0->x64_instrs, X64_XMM1, rsp_addr);
    X64_emit_instr_ucomisd_rm(&proc0->x64_instrs, X64_XMM11, r10_addr);
    X64_emit_instr_ret(&proc0->x64_instrs);
    X64_elf_gen_instrs(mem_arena, &proc0->x64_instrs, &elf_prog.buffer, &elf_prog.relocs, &elf_prog.proc_off_patches);

    Array(u8) nasm_buffer = array_create(mem_arena, u8, 64);
    const char* nasm_code = "proc0:\n"
                            " ucomiss xmm1, dword [rbp - 8]\n"
                            " ucomiss xmm1, dword [rsp - 8]\n"
                            " ucomiss xmm11, dword [r10 - 8]\n"
                            " ucomisd xmm1, qword [rbp - 8]\n"
                            " ucomisd xmm1, qword [rsp - 8]\n"
                            " ucomisd xmm11, qword [r10 - 8]\n"
                            " ret\n";
    if (!get_nasm_machine_code(&nasm_buffer, nasm_code, mem_arena)) {
        return false;
    }
...
static Elf_Gen_Test elf_gen_tests[] = {
    ...
    {"test_movzx_rr", test_movzx_rr},
    {"test_movzx_rm", test_movzx_rm},
    ...
    {"test_sub_flt_rr", test_sub_flt_rr},
    {"test_sub_flt_rm", test_sub_flt_rm},
    {"test_mul_flt_rr", test_mul_flt_rr},
    {"test_mul_flt_rm", test_mul_flt_rm},
    {"test_div_flt_rr", test_div_flt_rr},
    {"test_div_flt_rm", test_div_flt_rm},
    {"test_ucomp_flt_rr", test_ucomp_flt_rr},
    {"test_ucomp_flt_rm", test_ucomp_flt_rm},
    {"test_movdqu_rm", test_movdqu_rm},
    {"test_movdqu_mr", test_movdqu_mr},
};
