...
{
    X64_SIBD_Addr addr = {.kind = X64__SIBD_ADDR_LOCAL, .local = {.base_reg = X64_RBP, .index_reg = X64_REG_COUNT, .disp = offset}};
...
{
    X64_SIBD_Addr addr = {.kind = X64__SIBD_ADDR_LOCAL, .local = {.base_reg = X64_RSP, .index_reg = X64_REG_COUNT, .disp = offset}};
...
static void X64__emit_instr_mul_flt_rr(Array(X64__Instr) * instrs, FloatKind kind, X64_Reg dst, X64_Reg src)
{
    X64__Instr mul_flt_rr_instr = {
...
static void X64__emit_instr_mul_flt_rm(Array(X64__Instr) * instrs, FloatKind kind, X64_Reg dst, X64_SIBD_Addr src)
{
    X64__Instr mul_flt_rm_instr = {
...
static void X64__emit_instr_mul_flt_mr(Array(X64__Instr) * instrs, FloatKind kind, X64_SIBD_Addr dst, X64_Reg src)
{
    X64__Instr mul_flt_mr_instr = {
...
// f32 to int
static void X64__emit_instr_cvttss2si_rr(Array(X64__Instr) * instrs, X64_Reg dst, bool dst_8bytes, X64_Reg src)
{
...
static void X64__emit_instr_cvttss2si_rm(Array(X64__Instr) * instrs, X64_Reg dst, bool dst_8bytes, X64_SIBD_Addr src)
{
...
// f64 to int
static void X64__emit_instr_cvttsd2si_rr(Array(X64__Instr) * instrs, X64_Reg dst, bool dst_8bytes, X64_Reg src)
{
...
static void X64__emit_instr_cvttsd2si_rm(Array(X64__Instr) * instrs, X64_Reg dst, bool dst_8bytes, X64_SIBD_Addr src)
{
...
// int to f32
static void X64__emit_instr_cvtsi2ss_rr(Array(X64__Instr) * instrs, X64_Reg dst, X64_Reg src, bool src_8bytes)
{
...
static void X64__emit_instr_cvtsi2ss_rm(Array(X64__Instr) * instrs, X64_Reg dst, X64_SIBD_Addr src, bool src_8bytes)
{
...
// int to f64
static void X64__emit_instr_cvtsi2sd_rr(Array(X64__Instr) * instrs, X64_Reg dst, X64_Reg src, bool src_8bytes)
{
...
static void X64__emit_instr_cvtsi2sd_rm(Array(X64__Instr) * instrs, X64_Reg dst, X64_SIBD_Addr src, bool src_8bytes)
{
...
// Compare f32s
static void X64__emit_instr_ucomiss_rr(Array(X64__Instr) * instrs, X64_Reg dst, X64_Reg src)
{
    X64__Instr ucomiss_rr_instr = {
...
static void X64__emit_instr_ucomiss_rm(Array(X64__Instr) * instrs, X64_Reg dst, X64_SIBD_Addr src)
{
    X64__Instr ucomiss_rm_instr = {
...
// Compare f64s
static void X64__emit_instr_ucomisd_rr(Array(X64__Instr) * instrs, X64_Reg dst, X64_Reg src)
{
    X64__Instr ucomisd_rr_instr = {
...
static void X64__emit_instr_ucomisd_rm(Array(X64__Instr) * instrs, X64_Reg dst, X64_SIBD_Addr src)
{
    X64__Instr ucomisd_rm_instr = {
...
static inline X64_Emit_Bin_Int_RR_Func* x64_bin_int_rr_emit_funcs(X64_Instr_Kind kind)
{
    ...
    case X64_Instr_Kind_ADD_RR:
        return X64__emit_instr_add_rr;
    case X64_Instr_Kind_SUB_RR:
        return X64__emit_instr_sub_rr;
    case X64_Instr_Kind_IMUL_RR:
        return X64__emit_instr_imul_rr;
    case X64_Instr_Kind_AND_RR:
        return X64__emit_instr_and_rr;
    case X64_Instr_Kind_OR_RR:
        return X64__emit_instr_or_rr;
    case X64_Instr_Kind_XOR_RR:
        return X64__emit_instr_xor_rr;
    case X64_Instr_Kind_MOV_RR:
        return X64__emit_instr_mov_rr;
    case X64_Instr_Kind_CMP_RR:
        return X64__emit_instr_cmp_rr;
    default:
...
static inline X64_Emit_Bin_Int_RM_Func* x64_bin_int_rm_emit_funcs(X64_Instr_Kind kind)
{
    ...
    case X64_Instr_Kind_ADD_RM:
        return X64__emit_instr_add_rm;
    case X64_Instr_Kind_SUB_RM:
        return X64__emit_instr_sub_rm;
    case X64_Instr_Kind_IMUL_RM:
        return X64__emit_instr_imul_rm;
    case X64_Instr_Kind_AND_RM:
        return X64__emit_instr_and_rm;
    case X64_Instr_Kind_OR_RM:
        return X64__emit_instr_or_rm;
    case X64_Instr_Kind_XOR_RM:
        return X64__emit_instr_xor_rm;
    case X64_Instr_Kind_MOV_RM:
        return X64__emit_instr_mov_rm;
    case X64_Instr_Kind_CMP_RM:
        return X64__emit_instr_cmp_rm;
    default:
...
static inline X64_Emit_Bin_Int_RI_Func* x64_bin_int_ri_emit_funcs(X64_Instr_Kind kind)
{
    ...
    case X64_Instr_Kind_ADD_RI:
        return X64__emit_instr_add_ri;
    case X64_Instr_Kind_SUB_RI:
        return X64__emit_instr_sub_ri;
    case X64_Instr_Kind_IMUL_RI:
        return X64__emit_instr_imul_ri;
    case X64_Instr_Kind_AND_RI:
        return X64__emit_instr_and_ri;
    case X64_Instr_Kind_OR_RI:
        return X64__emit_instr_or_ri;
    case X64_Instr_Kind_XOR_RI:
        return X64__emit_instr_xor_ri;
    case X64_Instr_Kind_CMP_RI:
        return X64__emit_instr_cmp_ri;
    default:
...
static inline X64_Emit_Bin_Int_MR_Func* x64_bin_int_mr_emit_funcs(X64_Instr_Kind kind)
{
    ...
    case X64_Instr_Kind_ADD_MR:
        return X64__emit_instr_add_mr;
    case X64_Instr_Kind_SUB_MR:
        return X64__emit_instr_sub_mr;
    case X64_Instr_Kind_IMUL_MR:
        return X64__emit_instr_imul_mr;
    case X64_Instr_Kind_AND_MR:
        return X64__emit_instr_and_mr;
    case X64_Instr_Kind_OR_MR:
        return X64__emit_instr_or_mr;
    case X64_Instr_Kind_XOR_MR:
        return X64__emit_instr_xor_mr;
    case X64_Instr_Kind_MOV_MR:
        return X64__emit_instr_mov_mr;
    case X64_Instr_Kind_CMP_MR:
        return X64__emit_instr_cmp_mr;
    default:
...
static inline X64_Emit_Bin_Int_MI_Func* x64_bin_int_mi_emit_funcs(X64_Instr_Kind kind)
{
    ...
    case X64_Instr_Kind_ADD_MI:
        return X64__emit_instr_add_mi;
    case X64_Instr_Kind_SUB_MI:
        return X64__emit_instr_sub_mi;
    case X64_Instr_Kind_IMUL_MI:
        return X64__emit_instr_imul_mi;
    case X64_Instr_Kind_AND_MI:
        return X64__emit_instr_and_mi;
    case X64_Instr_Kind_OR_MI:
        return X64__emit_instr_or_mi;
    case X64_Instr_Kind_XOR_MI:
        return X64__emit_instr_xor_mi;
    case X64_Instr_Kind_MOV_MI:
        return X64__emit_instr_mov_mi;
    case X64_Instr_Kind_CMP_MI:
        return X64__emit_instr_cmp_mi;
    default:
...
static inline X64_Emit_Mov_Ext_RR_Func* x64_mov_ext_rr_emit_funcs(X64_Instr_Kind kind)
{
    ...
    case X64_Instr_Kind_MOVSX_RR:
        return X64__emit_instr_movsx_rr;
    case X64_Instr_Kind_MOVSXD_RR:
        return X64__emit_instr_movsxd_rr;
    case X64_Instr_Kind_MOVZX_RR:
        return X64__emit_instr_movzx_rr;
    default:
...
static inline X64_Emit_Mov_Ext_RM_Func* x64_mov_ext_rm_emit_funcs(X64_Instr_Kind kind)
{
    ...
    case X64_Instr_Kind_MOVSX_RM:
        return X64__emit_instr_movsx_rm;
    case X64_Instr_Kind_MOVSXD_RM:
        return X64__emit_instr_movsxd_rm;
    case X64_Instr_Kind_MOVZX_RM:
        return X64__emit_instr_movzx_rm;
    default:
...
static inline X64_Emit_Bin_Flt_RR_Func* x64_bin_flt_rr_emit_funcs(X64_Instr_Kind kind)
{
    ...
    case X64_Instr_Kind_ADD_FLT_RR:
        return X64__emit_instr_add_flt_rr;
    case X64_Instr_Kind_SUB_FLT_RR:
        return X64__emit_instr_sub_flt_rr;
    case X64_Instr_Kind_MUL_FLT_RR:
        return X64__emit_instr_mul_flt_rr;
    case X64_Instr_Kind_DIV_FLT_RR:
        return X64__emit_instr_div_flt_rr;
    case X64_Instr_Kind_MOV_FLT_RR:
        return X64__emit_instr_mov_flt_rr;
    default:
...
static inline X64_Emit_Bin_Flt_RM_Func* x64_bin_flt_rm_emit_funcs(X64_Instr_Kind kind)
{
    ...
    case X64_Instr_Kind_ADD_FLT_RM:
        return X64__emit_instr_add_flt_rm;
    case X64_Instr_Kind_SUB_FLT_RM:
        return X64__emit_instr_sub_flt_rm;
    case X64_Instr_Kind_MUL_FLT_RM:
        return X64__emit_instr_mul_flt_rm;
    case X64_Instr_Kind_DIV_FLT_RM:
        return X64__emit_instr_div_flt_rm;
    case X64_Instr_Kind_MOV_FLT_RM:
        return X64__emit_instr_mov_flt_rm;
    default:
...
static inline X64_Emit_Bin_Flt_MR_Func* x64_bin_flt_mr_emit_funcs(X64_Instr_Kind kind)
{
    ...
    case X64_Instr_Kind_ADD_FLT_MR:
        return X64__emit_instr_add_flt_mr;
    case X64_Instr_Kind_SUB_FLT_MR:
        return X64__emit_instr_sub_flt_mr;
    case X64_Instr_Kind_MUL_FLT_MR:
        return X64__emit_instr_mul_flt_mr;
    case X64_Instr_Kind_DIV_FLT_MR:
        return X64__emit_instr_div_flt_mr;
    case X64_Instr_Kind_MOV_FLT_MR:
        return X64__emit_instr_mov_flt_mr;
    default:
                                       ...
                                       u32 op1_lreg, u32 op2_lreg)
{
    ...
    case X64_LREG_LOC_REG: {
        ...
        case X64_LREG_LOC_STACK: {
            x64_bin_flt_rm_emit_funcs(instr_kind)(&proc_state->instrs, flt_kind, op1_loc.reg,
                                                  X64__get_rbp_offset_addr(op2_loc.offset));
            break;
        }
        default:
            assert(0);
    ...
    case X64_LREG_LOC_STACK: {
        switch (op2_loc.kind) {
        case X64_LREG_LOC_REG: {
            x64_bin_flt_mr_emit_funcs(instr_kind)(&proc_state->instrs, flt_kind, X64__get_rbp_offset_addr(op1_loc.offset),
                                                  op2_loc.reg);
            break;
        }
        case X64_LREG_LOC_STACK: {
...
static void X64__emit_mov_ext_rr_instr(X64_Proc_State* proc_state, X64_Instr_Kind instr_kind, u32 dst_size, u32 dst_lreg, u32 src_size,
                                       u32 src_lreg)
{
    ...
    case X64_LREG_LOC_STACK: {
        x64_mov_ext_rm_emit_funcs(instr_kind)(&proc_state->instrs, dst_size, dst_reg, src_size,
                                              X64__get_rbp_offset_addr(src_loc.offset));
        break;
    }
    default:
        assert(0);
...
static void X64__emit_mov_ext_rm_instr(X64_Proc_State* proc_state, X64_Instr_Kind movext_kind, u32 dst_size, u32 dst_lreg,
                                       u32 src_size, const X64_MemAddr* src_vaddr)
{
    ...
    X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
    X64_Reg dst_reg =
        X64__get_reg(&tmp_group, X64_REG_CLASS_INT, dst_lreg, dst_size, true, banned_tmp_regs); // Get actual reg or a tmp if spilled.
...
static void X64__emit_bin_int_ri_instr(X64_Proc_State* proc_state, X64_Instr_Kind instr_kind, u32 op_size, u32 op1_lreg,
                                       Scalar op2_imm)
{
    X64_LRegLoc op1_loc = X64__lreg_loc(proc_state, op1_lreg);
...
static void X64__gen_instr(X64_Proc_State* proc_state, const X64_Instr* instr, bool is_last_instr, long bblock_id)
{
    ...
    case X64_InstrMulSS_R_R_KIND: {
        const X64_InstrMulSS_R_R* act_instr = (const X64_InstrMulSS_R_R*)instr;
        X64__emit_bin_flt_rr_instr(proc_state, X64_Instr_Kind_MUL_FLT_RR, true, FLOAT_F32, act_instr->dst, act_instr->src);
        break;
    }
    case X64_InstrMulSS_R_M_KIND: {
        const X64_InstrMulSS_R_M* act_instr = (const X64_InstrMulSS_R_M*)instr;
        X64__emit_bin_flt_rm_instr(proc_state, X64_Instr_Kind_MUL_FLT_RM, true, FLOAT_F32, act_instr->dst, &act_instr->src);
        break;
    }
    // MULSD
    case X64_InstrMulSD_R_R_KIND: {
        const X64_InstrMulSD_R_R* act_instr = (const X64_InstrMulSD_R_R*)instr;
        X64__emit_bin_flt_rr_instr(proc_state, X64_Instr_Kind_MUL_FLT_RR, true, FLOAT_F64, act_instr->dst, act_instr->src);
        break;
    }
    ...
    case X64_InstrSar_R_I_KIND: {
        ...
        if (IS_LREG_IN_REG(dst_loc.kind)) {
            ...
            X64__emit_instr_sar_mi(&proc_state->instrs, dst_size, X64__get_rbp_offset_addr(dst_loc.offset), act_instr->src.as_int._u8);
        }
        break;
    }
    // SHL
    ...
    case X64_InstrShl_R_I_KIND: {
        ...
        if (IS_LREG_IN_REG(dst_loc.kind)) {
            ...
            X64__emit_instr_shl_mi(&proc_state->instrs, dst_size, X64__get_rbp_offset_addr(dst_loc.offset), act_instr->src.as_int._u8);
        }
        break;
    }
    // MOV
    ...
    case X64_InstrMov_R_I_KIND: {
        ...
        X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
        X64_Reg dst_reg =
            X64__get_reg(&tmp_group, X64_REG_CLASS_INT, act_instr->dst, size, true, 0); // Get actual reg or a tmp if spilled.
    ...
    case X64_InstrCvtSS2SD_R_R_KIND: { // f32 to f64
        ...
        if (IS_LREG_IN_REG(dst_loc.kind) && IS_LREG_IN_REG(src_loc.kind)) {
            ...
            X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
            X64_Reg dst_reg =
                X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->dst, float_kind_sizes[FLOAT_F64], true, (1 << src_loc.reg));
    ...
    case X64_InstrCvtSS2SD_R_M_KIND: { // f32 (in memory) to f64
        const X64_InstrCvtSS2SD_R_M* act_instr = (const X64_InstrCvtSS2SD_R_M*)instr;
        X64_SIBD_Addr src_addr = {0};
        u32 used_regs = X64__get_sibd_addr(proc_state, &src_addr, &act_instr->src);

        X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
        X64_Reg dst_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->dst, float_kind_sizes[FLOAT_F64], true, used_regs);
        X64__emit_instr_cvtss2sd_rm(&proc_state->instrs, dst_reg, src_addr);
        X64__end_reg_group(&tmp_group);
        break;
    }
    // CVTSD2SS
    case X64_InstrCvtSD2SS_R_R_KIND: { // f64 to f32
        ...
        if (IS_LREG_IN_REG(dst_loc.kind) && IS_LREG_IN_REG(src_loc.kind)) {
            ...
            X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
            X64_Reg dst_reg =
                X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->dst, float_kind_sizes[FLOAT_F32], true, (1 << src_loc.reg));
    ...
    case X64_InstrCvtSD2SS_R_M_KIND: { // f64 (in memory) to f32
        const X64_InstrCvtSD2SS_R_M* act_instr = (const X64_InstrCvtSD2SS_R_M*)instr;
        X64_SIBD_Addr src_addr = {0};
        u32 used_regs = X64__get_sibd_addr(proc_state, &src_addr, &act_instr->src);
    ...
    case X64_InstrCvtSS2SI_R_R_KIND: { // f32 to integer
        ...
        if (IS_LREG_IN_REG(dst_loc.kind) && IS_LREG_IN_REG(src_loc.kind)) {
            X64__emit_instr_cvttss2si_rr(&proc_state->instrs, dst_loc.reg, dst_is_8byte, src_loc.reg);
        }
        else if (IS_LREG_IN_REG(dst_loc.kind) && IS_LREG_IN_STACK(src_loc.kind)) {
            X64__emit_instr_cvttss2si_rm(&proc_state->instrs, dst_loc.reg, dst_is_8byte, X64__get_rbp_offset_addr(src_loc.offset));
        }
        else if (IS_LREG_IN_STACK(dst_loc.kind) && IS_LREG_IN_REG(src_loc.kind)) {
            X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
            X64_Reg dst_reg =
                X64__get_reg(&tmp_group, X64_REG_CLASS_INT, act_instr->dst, dst_is_8byte ? 8 : 4, true, (1 << src_loc.reg));
            X64__emit_instr_cvttss2si_rr(&proc_state->instrs, dst_reg, dst_is_8byte, src_loc.reg);
            X64__end_reg_group(&tmp_group);
        }
        else {
            assert(IS_LREG_IN_STACK(dst_loc.kind) && IS_LREG_IN_STACK(src_loc.kind));
            ...
            X64__emit_instr_cvttss2si_rm(&proc_state->instrs, dst_reg, dst_is_8byte, X64__get_rbp_offset_addr(src_loc.offset));
            X64__end_reg_group(&tmp_group);
        }
        break;
    }
    case X64_InstrCvtSS2SI_R_M_KIND: { // f32 (in memory) to integer
        const X64_InstrCvtSS2SI_R_M* act_instr = (const X64_InstrCvtSS2SI_R_M*)instr;
        ...
        X64__emit_instr_cvttss2si_rm(&proc_state->instrs, dst_reg, act_instr->dst_size == 8, src_addr);
        X64__end_reg_group(&tmp_group);
        break;
    }
    // CVTTSD2SI
    case X64_InstrCvtSD2SI_R_R_KIND: { // f64 to integer
        ...
        if (IS_LREG_IN_REG(dst_loc.kind) && IS_LREG_IN_REG(src_loc.kind)) {
            X64__emit_instr_cvttsd2si_rr(&proc_state->instrs, dst_loc.reg, dst_is_8byte, src_loc.reg);
        }
        else if (IS_LREG_IN_REG(dst_loc.kind) && IS_LREG_IN_STACK(src_loc.kind)) {
            X64__emit_instr_cvttsd2si_rm(&proc_state->instrs, dst_loc.reg, dst_is_8byte, X64__get_rbp_offset_addr(src_loc.offset));
        }
        else if (IS_LREG_IN_STACK(dst_loc.kind) && IS_LREG_IN_REG(src_loc.kind)) {
            X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
            X64_Reg dst_reg =
                X64__get_reg(&tmp_group, X64_REG_CLASS_INT, act_instr->dst, dst_is_8byte ? 8 : 4, true, (1 << src_loc.reg));
            X64__emit_instr_cvttsd2si_rr(&proc_state->instrs, dst_reg, dst_is_8byte, src_loc.reg);
            X64__end_reg_group(&tmp_group);
        }
        else {
            assert(IS_LREG_IN_STACK(dst_loc.kind) && IS_LREG_IN_STACK(src_loc.kind));
            X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
            X64_Reg dst_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_INT, act_instr->dst, dst_is_8byte ? 8 : 4, true, 0);
            X64__emit_instr_cvttsd2si_rm(&proc_state->instrs, dst_reg, dst_is_8byte, X64__get_rbp_offset_addr(src_loc.offset));
            X64__end_reg_group(&tmp_group);
        }
        break;
    }
    case X64_InstrCvtSD2SI_R_M_KIND: { // f64 (in memory) to integer
        const X64_InstrCvtSD2SI_R_M* act_instr = (const X64_InstrCvtSD2SI_R_M*)instr;
        ...
        X64__emit_instr_cvttsd2si_rm(&proc_state->instrs, dst_reg, act_instr->dst_size == 8, src_addr);
        X64__end_reg_group(&tmp_group);
        break;
    }
    // CVTSI2SS
    case X64_InstrCvtSI2SS_R_R_KIND: { // integer -> f32
        const X64_InstrCvtSI2SS_R_R* act_instr = (const X64_InstrCvtSI2SS_R_R*)instr;
        ...
        if (IS_LREG_IN_REG(dst_loc.kind) && IS_LREG_IN_REG(src_loc.kind)) {
            X64__emit_instr_cvtsi2ss_rr(&proc_state->instrs, dst_loc.reg, src_loc.reg, src_is_8bytes);
        }
        else if (IS_LREG_IN_REG(dst_loc.kind) && IS_LREG_IN_STACK(src_loc.kind)) {
            X64__emit_instr_cvtsi2ss_rm(&proc_state->instrs, dst_loc.reg, X64__get_rbp_offset_addr(src_loc.offset), src_is_8bytes);
        }
        else if (IS_LREG_IN_STACK(dst_loc.kind) && IS_LREG_IN_REG(src_loc.kind)) {
            X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
            X64_Reg dst_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->dst, dst_size, true, (1 << src_loc.reg));
            X64__emit_instr_cvtsi2ss_rr(&proc_state->instrs, dst_reg, src_loc.reg, src_is_8bytes);
            X64__end_reg_group(&tmp_group);
        }
        else {
            assert(IS_LREG_IN_STACK(dst_loc.kind) && IS_LREG_IN_STACK(src_loc.kind));
            X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
            X64_Reg dst_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->dst, dst_size, true, 0);
            X64__emit_instr_cvtsi2ss_rm(&proc_state->instrs, dst_reg, X64__get_rbp_offset_addr(src_loc.offset), src_is_8bytes);
            X64__end_reg_group(&tmp_group);
        }
        break;
    }
    case X64_InstrCvtSI2SS_R_M_KIND: { // integer (in memory) -> f32
        const X64_InstrCvtSI2SS_R_M* act_instr = (const X64_InstrCvtSI2SS_R_M*)instr;
        ...
        X64_SIBD_Addr src_addr = {0};
        const u32 used_regs = X64__get_sibd_addr(proc_state, &src_addr, &act_instr->src);

        X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
        X64_Reg dst_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->dst, dst_size, true, used_regs);

        X64__emit_instr_cvtsi2ss_rm(&proc_state->instrs, dst_reg, src_addr, src_is_8bytes);
        X64__end_reg_group(&tmp_group);
        break;
    }
    // CVTSI2SD
    case X64_InstrCvtSI2SD_R_R_KIND: { // integer -> f64
        const X64_InstrCvtSI2SD_R_R* act_instr = (const X64_InstrCvtSI2SD_R_R*)instr;
        ...
        if (IS_LREG_IN_REG(dst_loc.kind) && IS_LREG_IN_REG(src_loc.kind)) {
            X64__emit_instr_cvtsi2sd_rr(&proc_state->instrs, dst_loc.reg, src_loc.reg, src_is_8bytes);
        }
        else if (IS_LREG_IN_REG(dst_loc.kind) && IS_LREG_IN_STACK(src_loc.kind)) {
            X64__emit_instr_cvtsi2sd_rm(&proc_state->instrs, dst_loc.reg, X64__get_rbp_offset_addr(src_loc.offset), src_is_8bytes);
        }
        else if (IS_LREG_IN_STACK(dst_loc.kind) && IS_LREG_IN_REG(src_loc.kind)) {
            X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
            X64_Reg dst_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->dst, dst_size, true, (1 << src_loc.reg));
            X64__emit_instr_cvtsi2sd_rr(&proc_state->instrs, dst_reg, src_loc.reg, src_is_8bytes);
            X64__end_reg_group(&tmp_group);
        }
        else {
            assert(IS_LREG_IN_STACK(dst_loc.kind) && IS_LREG_IN_STACK(src_loc.kind));
            X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
            X64_Reg dst_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->dst, dst_size, true, 0);
            X64__emit_instr_cvtsi2sd_rm(&proc_state->instrs, dst_reg, X64__get_rbp_offset_addr(src_loc.offset), src_is_8bytes);
            X64__end_reg_group(&tmp_group);
        }
        break;
    }
    case X64_InstrCvtSI2SD_R_M_KIND: { // integer (in memory) -> f64
        const X64_InstrCvtSI2SD_R_M* act_instr = (const X64_InstrCvtSI2SD_R_M*)instr;
        ...
        X64__emit_instr_cvtsi2sd_rm(&proc_state->instrs, dst_reg, src_addr, src_is_8bytes);
        X64__end_reg_group(&tmp_group);
        break;
    }
    // CMP
    ...
    case X64_InstrUComiSS_R_R_KIND: {
        const X64_InstrUComiSS_R_R* act_instr = (const X64_InstrUComiSS_R_R*)instr;
        const X64_LRegLoc op2_loc = X64__lreg_loc(proc_state, act_instr->op2);
        const u8 op_size = float_kind_sizes[FLOAT_F32];

        X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);

        if (IS_LREG_IN_REG(op2_loc.kind)) {
            X64_Reg op1_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->op1, op_size, false, (1 << op2_loc.reg));
            X64__emit_instr_ucomiss_rr(&proc_state->instrs, op1_reg, op2_loc.reg);
        }
        else {
            assert(IS_LREG_IN_STACK(op2_loc.kind));
            X64_Reg op1_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->op1, op_size, false, 0);
            X64__emit_instr_ucomiss_rm(&proc_state->instrs, op1_reg, X64__get_rbp_offset_addr(op2_loc.offset));
        }
        X64__end_reg_group(&tmp_group);
        break;
    }
    case X64_InstrUComiSS_R_M_KIND: {
        const X64_InstrUComiSS_R_M* act_instr = (const X64_InstrUComiSS_R_M*)instr;
        const u8 op_size = float_kind_sizes[FLOAT_F32];
        X64_SIBD_Addr op2_addr = {0};
        u32 used_regs = X64__get_sibd_addr(proc_state, &op2_addr, &act_instr->op2);

        X64_Reg_Group tmp_group = X64__begin_reg_group(proc_state);
        X64_Reg op1_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->op1, op_size, false, used_regs);

        X64__emit_instr_ucomiss_rm(&proc_state->instrs, op1_reg, op2_addr);
        X64__end_reg_group(&tmp_group);
        break;
    }
    // UCOMISD
    case X64_InstrUComiSD_R_R_KIND: {
        const X64_InstrUComiSD_R_R* act_instr = (const X64_InstrUComiSD_R_R*)instr;
        const X64_LRegLoc op2_loc = X64__lreg_loc(proc_state, act_instr->op2);
        ...
        if (IS_LREG_IN_REG(op2_loc.kind)) {
            X64_Reg op1_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->op1, op_size, false, (1 << op2_loc.reg));
            X64__emit_instr_ucomisd_rr(&proc_state->instrs, op1_reg, op2_loc.reg);
        }
        else {
            assert(IS_LREG_IN_STACK(op2_loc.kind));
            X64_Reg op1_reg = X64__get_reg(&tmp_group, X64_REG_CLASS_FLOAT, act_instr->op1, op_size, false, 0);
            X64__emit_instr_ucomisd_rm(&proc_state->instrs, op1_reg, X64__get_rbp_offset_addr(op2_loc.offset));
        }
        X64__end_reg_group(&tmp_group);
        break;
    }
    case X64_InstrUComiSD_R_M_KIND: {
        const X64_InstrUComiSD_R_M* act_instr = (const X64_InstrUComiSD_R_M*)instr;
        const u8 op_size = float_kind_sizes[FLOAT_F64];
        X64_SIBD_Addr op2_addr = {0};
        u32 used_regs = X64__get_sibd_addr(proc_state, &op2_addr, &act_instr->op2);
        ...
        X64__emit_instr_ucomisd_rm(&proc_state->instrs, op1_reg, op2_addr);
        X64__end_reg_group(&tmp_group);
        break;
    }
    // LEA
