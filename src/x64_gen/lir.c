...
{
    X64_InstrKind kind = src_kind == FLOAT_F64 ? X64_INSTR_CVTSD2SI_R_R : X64_INSTR_CVTSS2SI_R_R;
...
{
    X64_InstrKind kind = src_kind == FLOAT_F64 ? X64_INSTR_CVTSD2SI_R_M : X64_INSTR_CVTSS2SI_R_M;
