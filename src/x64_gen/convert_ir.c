...
static X64_LIRCreateFunc X64_lir_funcs[IR_INSTR_KIND_COUNT] = {
    ...
    [IR_InstrFlt2Int_KIND] = X64_fun,
    [IR_InstrInt2Flt_KIND] = X64_fun,
    [IR_InstrFlt2Flt_KIND] = X64_fun,
    [IR_InstrLImm_KIND] = X64_fun,
