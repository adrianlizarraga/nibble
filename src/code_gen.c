...
typedef bool GenModuleProc(Allocator* gen_mem, Allocator* tmp_mem, IR_Module* module, HMap* str_lit_map, const char* output_file);
...
{
    return target_gen_module(gen_mem, tmp_mem, module, str_lit_map, output_file);
}
