...
typedef bool GenModuleProc(Allocator* gen_mem, Allocator* tmp_mem, IR_Module* module, const char* output_file);
...
{
    return target_gen_module(gen_mem, tmp_mem, module, output_file);
}
